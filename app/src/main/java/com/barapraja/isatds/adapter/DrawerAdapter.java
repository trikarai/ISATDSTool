package com.barapraja.isatds.adapter;
...
/**
 * Created by Tri Sutrisno on 04/01/2016. tri
 */
public class DrawerAdapter extends RecyclerView.Adapter<DrawerAdapter.ViewHolder> {
    ...
    public DrawerAdapter(String Titles[], int Icons[], String Name, String Email, int Profile){ // Data1RecyclerAdapter Constructor with titles and icons parameter
